...
class CurrentDateBeforeOrEqual implements ValidationRule
{
    ...
    public function validate(string $attribute, mixed $value, Closure $fail): void
    {
        try {
            ...
            if(!empty($this->param)) {
                ...
                if ($parseDate->lt($parseParamDate->startOfDay())) {
                    $fail('The :attribute must be greater or equal to '.str_replace('_', ' ', $this->param).'.');
                }
